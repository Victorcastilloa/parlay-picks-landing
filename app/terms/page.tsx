        ...
        <div className="prose prose-invert prose-zinc max-w-none space-y-10 text-[15px] leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2 mt-3">
              <li><strong className="text-white">United States — Restricted States:</strong> Nevada (NV), New York (NY), Connecticut (CT), Indiana (IN), Idaho (ID), Utah (UT), Wisconsin (WI), Alabama (AL), Alaska (AK), Georgia (GA), Hawaii (HI), South Carolina (SC), Texas (TX), Minnesota (MN), Missouri (MO), Oklahoma (OK), California (CA)</li>
