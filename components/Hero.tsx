...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center pt-20 pb-20 overflow-hidden">
      ...
      <div className="absolute top-[-20%] left-1/2 -translate-x-1/2 w-[900px] h-[700px] bg-cyan-500/[0.07] blur-[150px] rounded-full pointer-events-none" />

      <div className="relative max-w-6xl mx-auto px-6 w-full py-16 sm:py-24">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          {/* Copy */}
          <div className="text-center lg:text-left">
            <div className="fade-up inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full border border-cyan-500/20 bg-cyan-500/[0.06] text-[12px] text-cyan-300 font-medium mb-8">
            ...
            <h1 className="fade-up delay-1 text-4xl sm:text-5xl lg:text-[3.75rem] font-bold tracking-[-0.03em] leading-[1.1] text-white mb-6">
            ...
            <p className="fade-up delay-2 text-base sm:text-lg text-zinc-400 max-w-md mx-auto lg:mx-0 mb-10 leading-relaxed">
              Live odds from 40+ bookmakers. AI analysis of injuries, matchups, and line movement. Delivered to your Telegram in seconds.
            </p>

            <div className="fade-up delay-3 flex flex-wrap justify-center lg:justify-start gap-3 mb-10">
            ...
            <div className="fade-up delay-4 flex flex-wrap justify-center lg:justify-start gap-x-6 gap-y-2 text-[12px] text-zinc-600">
          ...
          {/* Bot Preview */}
          <div className="fade-up delay-5 relative max-w-md mx-auto lg:mx-0 w-full">
            ...
            <div className="relative card p-6 sm:p-7">
              <div className="flex items-center gap-3 mb-5 pb-5 border-b border-white/[0.06]">
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-cyan-500 to-cyan-700 flex items-center justify-center text-lg flex-shrink-0">🎯</div>
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-semibold text-white">Parlay Picks Bot</p>
                  <p className="text-[11px] text-emerald-400 flex items-center gap-1">
                    <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 inline-block flex-shrink-0" />Online
                  </p>
                </div>
                <span className="text-[11px] text-zinc-600 flex-shrink-0">just now</span>
              </div>
                ...
                <div className="space-y-2.5 mb-3 font-mono text-[13px]">
                  {[["1","Celtics -3.5","-110"],["2","Chiefs ML","-145"],["3","Over 215.5 (LAL/GSW)","-108"]].map(([n,t,o]) => (
                    <div key={n} className="flex justify-between items-center gap-2">
                      <span className="text-zinc-400 truncate"><span className="text-cyan-400 font-semibold mr-2">{n}</span>{t}</span>
                      <span className="text-zinc-600 flex-shrink-0">{o}</span>
                    </div>
                  ))}
                </div>
              ...
              <div className="flex gap-2">
                <div className="flex-1 bg-white/[0.04] border border-white/[0.06] rounded-lg py-2.5 text-center text-[11px] text-zinc-500">💾 Save Pick</div>
                <div className="flex-1 bg-cyan-500/10 border border-cyan-500/20 rounded-lg py-2.5 text-center text-[11px] text-cyan-400">🔄 New Parlay</div>
              </div>
            </div>
          </div>
        </div>
